...
export const Navigation = () => {
  ...
  return (
    <>
      ...
      />
      <nav className={`absolute top-8 sm:top-2 ${!isOpen ? 'right-full' : 'right-auto'} sm:right-auto flex justify-between sm:block mx-1 py-[2.5rem] px-2 sm:px-4 w-[80%] max-w-[350px] font-anonymous-pro font-bold text-xl bg-secondary border-[5px] border-black shadow rounded-[60px]`}>
        <Link href="/">
