...
export const CategoryLabel = ({ children, Icon, variant = 'destructive', href }: CategoryLabelProps) => {
  return (
    <Link
      href={{ pathname: href }}
      className={`relative inline-block p-2 min-w-24 font-anonymous-pro font-bold text-4xl bg-${variant} text-${variant}-foreground border-[3px] border-black shadow hover:shadow-hover hover:-translate-x-[2px] hover:-translate-y-[2px] rounded-2xl`}
    >
